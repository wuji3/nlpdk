...
from arguments import ModelArguments, DataArguments, TrainingArgumentDK
...
def main():
    parser = HfArgumentParser((ModelArguments, DataArguments, TrainingArgumentDK))
    model_args, data_args, training_args = parser.parse_args_into_dataclasses()
    model_args: ModelArguments
    data_args: DataArguments
    training_args: TrainingArgumentDK
